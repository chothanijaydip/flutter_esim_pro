...
public class FlutterEsimProPlugin: NSObject, FlutterPlugin {
    
    public private(set) static var sharedInstance: FlutterEsimProPlugin!
    ...
    private static func createMethodChannel(messenger: FlutterBinaryMessenger) -> FlutterMethodChannel {
        return FlutterMethodChannel(name: "flutter_esim_pro", binaryMessenger: messenger)
    }
    
    private static func createEventChannel(messenger: FlutterBinaryMessenger) -> FlutterEventChannel {
        return FlutterEventChannel(name: "flutter_esim_pro_events", binaryMessenger: messenger)
    }
