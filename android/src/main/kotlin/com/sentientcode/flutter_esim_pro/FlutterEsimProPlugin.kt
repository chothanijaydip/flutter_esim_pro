package com.sentientcode.flutter_esim_pro
...
/** FlutterEsimProPlugin */
class FlutterEsimProPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    companion object {
        ...
        private lateinit var instance: FlutterEsimProPlugin
        ...
        fun initSharedInstance(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
            if (!::instance.isInitialized) {
                instance = FlutterEsimProPlugin()
                instance.context = flutterPluginBinding.applicationContext
            }

            val channel = MethodChannel(flutterPluginBinding.binaryMessenger, "flutter_esim_pro")
            methodChannels[flutterPluginBinding.binaryMessenger] = channel
            channel.setMethodCallHandler(instance)

            val events = EventChannel(flutterPluginBinding.binaryMessenger, "flutter_esim_pro_events")
